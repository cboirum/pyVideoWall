...
def startClientSub(client,host):
    '''
    Starts a client as a subprocess so that it will work with
    executables
    '''
    pass
...
def CreateServer(modType = modType):
    '''
    import friendly function call to create a server
    '''
    app = wx.App(False)
    host = ''
    frame = tileMain.MyFrame(None)
    frame.createModel(modType, frame.panel)
